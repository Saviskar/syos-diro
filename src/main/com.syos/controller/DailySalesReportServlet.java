...
import main.com.syos.service.GenerateDailySalesReportUseCase;
...
@WebServlet("/api/reports/daily-sales")
public class DailySalesReportServlet extends HttpServlet {
    private GenerateDailySalesReportUseCase reportUseCase;
    ...
    public void init() {
        ...
        this.reportUseCase     = new GenerateDailySalesReportUseCase(billDAO, lineDAO, itemDAO);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            List<Map<String,Object>> report = reportUseCase.execute(date);
